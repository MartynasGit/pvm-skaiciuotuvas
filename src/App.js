          ...
          <div className="box d-flex justify-content-between">
            ...
            <div className="col-8 ">
              <select
                ...
                onChange={(e) => {
                  selectorOnChange(e.target.value);
                }}
              >
          ...
          <div className="d-flex mt-3 justify-content-between">
            ...
            <div className="col-8">
              <input
                className="form-control"
                name="bendra"
                value={+pvmS.toFixed(2)}
                onChange={(e) => numberChange(e.target)}
              />
            </div>
          </div>
        </div>
        <SkaiciuKonverteris num={pvmS} />
        <div className="Bottom m-4">
          Įveskite sumą be PVM arba bendrą sumą (su PVM).{" "}
        </div>
      </div>
      <span className="fw-bold copy fs-6"> {year} © MartynasGit</span>
    </div>
  );
}
